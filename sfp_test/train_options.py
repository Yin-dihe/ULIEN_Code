...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--niter', type=int, default=100, help='# 100 of iter at starting learning rate')
        self.parser.add_argument('--niter_decay', type=int, default=100, help='# 100 of iter to linearly decay learning rate to zero')
